...
class User(BaseModel, db.Model):
    ...
    def to_dict(self):
        resp_dict = {
            "name": self.name,
            "avatar_url": constants.QINIU_IMAGE_IP_NAME + self.avatar_url if self.avatar_url else "",
            "mobile": self.mobile
        }
        return resp_dict
...
class House(BaseModel, db.Model):
    ...
    def to_basic_dict(self):
        ...
        house_dict = {
            ...
            "img_url": constants.QINIU_IMAGE_IP_NAME + self.index_image_url if self.index_image_url else "",
            "room_count": self.room_count,
            "order_count": self.order_count,
            "address": self.address,
            "user_avatar": constants.QINIU_IMAGE_IP_NAME + self.user.avatar_url if self.user.avatar_url else "",
    ...
    def to_full_dict(self):
        ...
        for image in self.images:
            img_urls.append(constants.QINIU_IMAGE_IP_NAME + image.url)
...
class Order(BaseModel, db.Model):
    ...
    trade_no = db.Column(db.String(80))  # 支付宝流水账单号码
    ...
    def to_dict(self):
        ...
        order_dict = {
            ...
            "img_url": constants.QINIU_IMAGE_IP_NAME + self.house.index_image_url if self.house.index_image_url else "",
